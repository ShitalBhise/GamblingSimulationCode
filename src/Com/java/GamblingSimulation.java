...
public class GamblingSimulation {
	...
	public static void luckyDay() {
		if (daysWonCount > daysLostCount)
			System.out.println("It's My Luckiest Month so i want to continue for next month");
		else
			System.out.println("It's My Unlucky Month so i dont want to contine for next month");
	}

	public static void continueORStopPlay() {
		if (daysWonCount > daysLostCount) {
